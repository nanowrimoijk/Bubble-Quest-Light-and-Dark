...
penta_spike = Bubble('Penta-Spike', '45', jab, spike, spike_ring, spike_beam, '7', '880', '20', '0', 'Normal', '4', '4', '45', '880', none, 'Unkown_For_Now')

jab = Bubble('Jab', '35', cut, jab, xcannon, none, '3', '640', '1', '0', 'Normal', '3', '3', '35', '640', penta_spike, '20')

slasher = Bubble('Slasher', '55', spin, rollout, xslash, slash_charge, '13', '760', '20', '0', 'Normal', '4', '4', '55', '760', none,'Unkown_For_Now')

spin = Bubble('Spin', '40', slash, spin, rollout, none, '7', '520', '1', '0', 'Normal', '3', '3', '40', '520', slasher, '20')

screen = Bubble('Screen', '40', block, screen_slash, spike_screen, screen_ram, '5', '960', '20', '0', 'Normal', '4', '4', '40', '960', none, 'Unkown_For_Now')
...
rip = Bubble('Rip', '35', tear, rip, shred, none, '5', '560', '1', '0', 'Fighting', '4', '3', '35', '560', none, 'Unkown_For_Now')

shield = Bubble('Shield', '25', ram, crash, shield, deflection_shield, '3', '680', '1', '0', 'Steel', '4', '4', '25', '680', none, 'Unkown_For_Now')

smasher = Bubble('Smasher', '10', uppercut, quake_smash, orbit_smash, deadly_torando_smash, '1', '1200', '1', '0', 'Fighting', '4', '4', '10', '1200', none, 'Unkown_For_Now')

rager = Bubble('Rager', '15', mad, rage, trigger, none, '5', '640', '1', '0', 'Fighting', '3', '3', '15', '640', smasher, '30')

twin = Bubble('Twin', '35', fire_blast, water_cannon, fusion_beam, none,'7', '680', '1', '0', 'Psychic', '3', '3', '35', '680', none, 'Unkown_For_Now')

miner = Bubble('Miner', '25', pebble_rain, earthquake, rock_toss, none, '5', '560', '1', '0', 'Rock', '3', '3', '25', '560', none, 'Unkown_For_Now')

cannonball = Bubble('Cannonball', '20', swipe, rollout_shield, ram, fiery_smash, '5', '680', '1', '0',
'Steel', '4', '4', '20', '680', none, 'Unkown_For_Now')

antser = Bubble('Antser', '25', bite, headbutt, rock_slice, none, '3', '640', '1', '0', 'Rock', '3', '3', '25', '640', none, 'Unkown_For_Now')

tank = Bubble('Tank', '60',bash, blast, laser, bullet_wave, '11', '1280', '65', '0', 'Steel', '4', '4', '60', '1280', none, 'Unkown_For_Now')
...
asilate = Bubble('Asilate', '20', creep, shadow_strike, hidden_blade, none, '8', '580', '1', '0', 'Dark', '4', '3', '20', '580', none, 'Unknown_For_Now')

grelone = Bubble('Grelone', '18', bite, seed_bomb, grass_blade, none, '3', '460', '1', '0', 'Grass', '4','3', '18', '480', none, 'Unknown_For_Now')
